      ...
      {stats.map((stat) => {
        ...
        return (
          <Link
            key={stat.label}
            href={stat.href}
            className="group rounded-[1.35rem] border border-slate-200/70 bg-white/85 p-4 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:bg-white hover:shadow-soft"
          >
